...
skin_buckling = SkinBuckling(n_ribs=12, area=Area_crosssection, chord= wb.chord, flange= 12, t_spar= 0.003, wingbox_geometry=wb.geometry, M =M, N= M, stringers=1, I_tot=I, wingspan=wb.wingspan, E= E, v=0.33, t_skin=t_caps)
